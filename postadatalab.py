...
st.set_page_config(page_icon=":bar_chart:", page_title="EDA Automated")

st.title("POSTA DATALAB: Automticaly analyse company data built specifically for Posta Tanzania :bar_chart:")
